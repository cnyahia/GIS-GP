...
adds the *maximum* NWM predicition
...
def processNWM(roadLayer, NWM):
    '''
    -----
    :param roadLayer: GIS shapefile with the road layers
    :param NWMdata: xarray with NWM data, see getNWMdata.py
    :returns None:
    -----
    edits the GIS files by adding the maximum NWM prediction for the 
    day to the roadLayer shapefile
    -----
    '''
